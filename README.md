...
- Graphics past shape art — six references as the bar (painterly, pixel-art, candle-lit, three-quarter, painted HD): bake-first engine contract, curves and brushes, materials and emission as tokens, a per-app `look`, scene documents, a style probe. Proposal and spikes in [docs/graphics-capability-plan.md](docs/graphics-capability-plan.md); nothing landed
