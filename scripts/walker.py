...
def coat_points(kind, sn, sf, hem):
    ...
    if kind == "hump":      # a bell whose back rises over the load
        return [[sn[0] + 0.4, sn[1] - 0.6], [sf[0] - 0.6, sf[1] - 0.2], [7.5, 1.6], [7.7, 6.0], [6.8, 10.6 + hem], [4.4, 11.9 + hem], [0.2, 12.3 + hem], [-4.2, 11.9 + hem], [-7.0, 10.6 + hem], [-8.6, 6.0], [-9.8, 0.4], [-9.6, -4.4], [-7.6, -7.2]]
...
def head_parts(kind, S, C, P):
    ...
    if kind == "bare":      # skin, and hair over it — no helmet
...
CHARACTERS = {
    ...
    "sol": {
        ...
        "extras": lambda c: [
            ...
            ("over_coat", P_("pouch", (5.4, 4.8), rect(3.0, 3.0, 0.8), "$timber", stroke=hair), "body"),
            ("over_coat", P_("cap", (5.8, 2.7), circ(1.3), "$pink"), "body"),
        ],
    ...
    "haram": {
        ...
        "extras": lambda c: [
            ("behind", P_("stake_a", (-9.6, -9.0), rect(1.1, 9.4, 0.3), "$timber", rot=-26), "head"),
            ("behind", P_("stake_b", (-8.2, -9.8), rect(1.1, 8.8, 0.3), "$timber.dark", rot=-16), "head"),
            ("behind", P_("stake_c", (-10.8, -7.8), rect(1.1, 8.2, 0.3), "$timber", rot=-36), "head"),
            ("behind", P_("tube", (-10.2, 2.0), rect(2.4, 7.0, 1.1), "$bone", rot=-6, stroke=hair), "body"),
            ("over_coat", P_("chestplate", (2.8, 4.6), rect(6.0, 6.4, 1.2), "$husk", rot=-4, stroke=hair), "body"),
            ("over_coat", P_("pauldron", (c["sn"][0] + 0.8, c["sn"][1] + 0.2), ell(3.6, 2.2), "$husk", rot=-10, stroke=hair), "body"),
            ("over_coat", P_("pauldron_far", (c["sf"][0] - 0.6, c["sf"][1] + 0.4), ell(3.2, 2.0), "$husk", rot=12, stroke=hair), "body"),
        ],
    ...
    "kano": {
        ...
        "walk_desc": "the patrol's stride: long, even, the staff planted with the far hand, no wasted motion",
    ...
    "eden": {
        ...
        "extras": lambda c: [
            ...
            ("over_coat", P_("jar", (6.0, 7.8), rect(3.0, 3.8, 0.6), "$silent", stroke=hair), "body"),
            ("over_coat", P_("jar_cap", (6.0, 5.6), rect(3.2, 0.9, 0.3), "$slate"), "body"),
            ("over_coat", P_("seed", (6.0, 8.2), poly([(-0.6, 1.2), (0.7, 1.0), (0.3, -1.3), (-0.4, -1.1)]), "$frost.light2"), "body"),
            ("over_coat", P_("patch", (-4.0, 6.4), rect(2.8, 2.2, 0.5), "$moss", rot=12), "body"),
            ("over_coat", P_("patch_b", (1.6, 10.4), rect(2.4, 1.9, 0.5), "$moss", rot=-8), "body"),
        ],
    ...
    "rowan": {
        ...
        "extras": lambda c: [
            ...
            ("in_hand", P_("knuckles", (c["hand"][0] + 0.2, c["hand"][1] + 0.9), rect(3.6, 1.0, 0.4), "$carapace.dark"), "arm"),
            ("in_hand", P_("thumb", (c["hand"][0] + 2.6, c["hand"][1] - 1.2), ell(1.0, 1.5), "$carapace", rot=20, stroke=hair), "arm"),
