...
CHARACTERS = {
    ...
    "haram": {
        ...
        "extras": lambda c: [
            ...
            ("over_cape", P_("pod_a", (c["sf"][0] + 0.4, c["sf"][1] - 1.6), circ(1.6), "$pink", stroke=hair), "body"),
            ("over_cape", P_("pod_b", (c["sf"][0] + 2.6, c["sf"][1] + 0.6), circ(1.3), "$pink", stroke=hair), "body"),
            ("over_cape", P_("pod_c", (c["sf"][0] - 1.4, c["sf"][1] - 0.2), circ(1.1), "$pink.light", stroke=hair), "body"),
        ],
